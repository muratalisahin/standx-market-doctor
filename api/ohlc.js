export default async function handler(req,res){
  ...
  else if(source==="yahoo") url=`https://query1.finance.yahoo.com/v8/finance/chart/${encodeURIComponent(symbol)}?interval=${encodeURIComponent(interval)}&range=${limit>=80?"1y":"3mo"}`;
